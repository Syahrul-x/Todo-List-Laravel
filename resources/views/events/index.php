    ...
    <div class="flex flex-col lg:flex-row min-h-screen">
        ...
        <aside class="w-full lg:w-1/4 bg-[#2c2e31] p-4 shadow-lg lg:h-screen">
            ...
            <nav class="mt-4">
                ...
                <ul class="space-y-3">
                    <li><a href="?c=dashboard&m=index" class="flex items-center p-2 rounded-md text-[#e0e0e0] hover:bg-[#3a3a3a] hover:text-[#2684FF] transition-colors"><span class="mr-2">📄</span> All content</a></li>
                    ...
                    <li><a href="?c=event&m=index" class="flex items-center p-2 rounded-md bg-[#3a3a3a] text-[#2684FF] transition-colors"><span class="mr-2">🗓️</span> Event List</a></li>
                </ul>
            </nav>
        </aside>
