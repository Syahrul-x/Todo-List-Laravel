    ...
    <form method="POST" action="?c=category&m=edit&id=<?= $category->id ?>" class="space-y-4">
        ...
        <div>
            ...
            <textarea id="description" name="description" rows="4"
                class="w-full p-2 rounded bg-gray-800 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"><?= htmlspecialchars($category->description) ?></textarea>
        </div>
